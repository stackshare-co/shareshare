                            ...
                            <div class="conversation-list-avatar col-md-2 ">
                                <div>
                                    <img src="{{asset('/img/profile/'.$question->img_user)}}"
                                         ...
                                         style="z-index:1;border-radius:50%;border: 2px solid #fff;width: 70%;max-width: 100%;background: #fff!important;margin-top: 15px;margin-left: -15px">
                                </div>
                            </div>
                            <div class=" col-md-8 " style="margin-left: -60px;margin-top: 15px">
                                <h4>
                                ...
                                <a  class="group-edit" href="{{route('editquestion', [$question->id])}}"><i
                                            class="fa fa-pencil-square-o fa-2x" style="color: #b8bbc4;"
                                            aria-hidden="true"></i></a>
                                <a class="group-delete" href="{{route('deletequestion', [$question->id])}}"><i
                                            class="fa fa-trash-o fa-2x" style="color: #d9534f; padding: 2px;"
                                            aria-hidden="true"></i></a>
