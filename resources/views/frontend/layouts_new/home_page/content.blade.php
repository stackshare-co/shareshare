        ...
        <div class="conversation-list">
            ...
            <div class="conversation-list-title col-md-8 is-position">
                ...
                <div class="conversation-list-answer-count ">
                    {{count(\App\Models\Answer::where('id_question', $result_questions->id)->get())}}&nbsp ចម្លើយ
                </div>
                <div class="conversation-list-view-count ">{{$result_questions->count_view}}&nbsp;មើល
                </div>
            </div>
            <div class="row">
...
{{--<div class="container text-center" style="margin-left: -100px;position: absolute; margin-top:150px;">--}}

{{--{{$result_question->render()}}--}}
