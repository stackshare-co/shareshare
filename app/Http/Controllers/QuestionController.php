...
class QuestionController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('frontend.layouts_new.question.edit', compact('question','result_question', 'notification_nav_bars'));
    }
    ...
    public function index($id)  // id is id'question
    {
        ...
        if(count($vote->getIterator()) > 0){
            ...
            return view('frontend.layouts_new.question.index', compact('question','result_question', 'user', 'votequestion', 'answer', 'notification_nav_bars'));
        } else{
            $votequestion = null;
            return view('frontend.layouts_new.question.index', compact('question','result_question', 'user', 'votequestion', 'answer', 'notification_nav_bars'));
        }
    ...
    public function myquestion(){
        ...
        $notification_nav_bars = Notification::where('id_user_passive', \auth()->id())->get();
        $result_question = Question::all();
        return view('frontend.layouts_new.question.myquestion', compact('questions','result_question', 'notification_nav_bars'));
    }
